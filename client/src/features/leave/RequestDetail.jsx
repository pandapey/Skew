...
// Render a stored timestamp as "12 Mar 2025 · 4:15 PM" — Part 2 requires both the
// decision DATE and TIME to be visible.
...
// Request detail drawer with an approval-workflow timeline + optional actions.
    ...
    >
      ...
      <div className="mb-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
        {[
          ...
          // Part 3: duration renders 0.5 correctly and names the session.
      ...
      {/* Part 4: make the Sunday exclusion explicit so the deduction is auditable. */}
      ...
      {/* Part 2: the approver's mandatory comment, with who/when. */}
      {decision?.comment && (
        <div
