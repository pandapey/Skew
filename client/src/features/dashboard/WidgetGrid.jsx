...
// Renders the user's personalized widget set. Order/visibility/pinning comes
// from `workspace.dashboardLayout` (via `useWorkspace()` in the parent) — this
// component only knows how to lay widgets out, never which ones exist, so new
// widgets never require touching this file.
