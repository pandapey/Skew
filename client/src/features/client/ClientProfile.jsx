      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-1">
          ...
          <div className="mt-4 border-t border-app pt-2">
            ...
            {/* Phase 6.9 (TASK 10): the Account Manager row is removed - the
                role does not exist in the system any more. */}
        ...
        {/* Task 5: Change Password moves INTO the 3-column grid as the third,
            right-most column, filling the empty space that used to sit beside
            Company Details when that card spanned both remaining columns
            (lg:col-span-2). Same existing component, same existing grid system
            - grid-cols-1 already stacks all three sections on mobile/tablet with
            no extra responsive code needed, so nothing here changes on small
            screens. Not duplicated: this is the only place ChangePasswordCard is
            rendered in this file, and pages/Profile.jsx (staff) renders its own
            separate instance inside its own tabs, unaffected by this file. */}
