// Phase 5.8 (Task 2): shared "Project Communication Center" thread component.
// Reused by BOTH ClientMessages.jsx (project picker + this thread) and
// ClientProjectDetail.jsx's "Discussion" tab (pinned to one project) so there
// is exactly ONE comment UI implementation - no duplicate chat system.
// Backed entirely by the existing ProjectComment collection via
// clientService.getProjectComments/addProjectComment/updateProjectComment/
// deleteProjectComment/uploadCommentAttachment (see clientController.js).
