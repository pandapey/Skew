...
// Shared error page shell for 404 / 403 / 500.
//
// Phase 6.10 (TASK 3): `homePath` added (default '/dashboard', i.e. the existing
// behaviour is unchanged for every current caller). The new route-level
// errorElement passes '/client' for portal URLs, so a client hitting an error
// is not offered a "Back to Dashboard" link into the staff tree that their RBAC
