...
import { FiUsers, FiTrello, FiMessageSquare } from 'react-icons/fi'
...
export default function Search() {
  ...
  return (
    <div>
      <PageHeader title="Global Search" subtitle="Search across employees, projects, announcements and more." />
