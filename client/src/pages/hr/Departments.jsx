...
export default function Departments() {
  ...
  return (
    <EntityManager
      title="Departments"
      // Phase 5.9 (Task 7): declared explicitly instead of relying on
      // EntityManager's implicit HR_WRITE_ROLES default. Same effective
      // permission, but the module's intent is now stated in the page.
