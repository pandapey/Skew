...
- **MongoDB** 5.0+ — local Community Server or MongoDB Atlas. Local dev uses `mongodb://127.0.0.1:27017/skew`.
...
```
PORT=5000
MONGO_URI=mongodb://127.0.0.1:27017/skew
...
mongosh "mongodb://127.0.0.1:27017/skew" --eval "db.dropDatabase()"
```

### Connect to MongoDB

- **Compass:** `mongodb://127.0.0.1:27017/skew`
- **Shell:** `mongosh "mongodb://127.0.0.1:27017/skew"`
...
| Role        | Email               | Password     |
|-------------|---------------------|--------------|
| Super Admin | admin@skew.com      | admin123     |
| Admin       | admin2@skew.com     | admin123     |
| Admin       | admin3@skew.com     | admin123     |
| HR          | hr@skew.com         | hr123        |
| Manager     | manager@skew.com    | manager123   |
| Sales       | sales@skew.com      | sales123     |
| Finance     | finance@skew.com    | finance123   |
